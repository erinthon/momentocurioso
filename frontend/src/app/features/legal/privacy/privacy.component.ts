...
@Component({
  ...
  `],
  template: `
    <app-legal-shell title="Política de Privacidade" updatedAt="13 de julho de 2026">
      <p>
...
export class PrivacyComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.seo.setPage({
      ...
      description: 'Como o Momento Curioso trata os seus dados: cookies, Google Analytics, AdSense e os seus direitos pela LGPD.',
      path: '/privacidade'
    });
  }
