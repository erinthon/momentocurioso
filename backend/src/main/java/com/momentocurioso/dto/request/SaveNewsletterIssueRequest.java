...
public record SaveNewsletterIssueRequest(
        ...
        @Size(max = 2048) @Pattern(regexp = "^$|https://.*", message = "A URL do vídeo deve usar HTTPS") String videoUrl,
        @Size(max = 255) String recommendationTitle,
        @Size(max = 2048) @Pattern(regexp = "^$|https://.*", message = "A URL da recomendação deve usar HTTPS") String recommendationUrl,
